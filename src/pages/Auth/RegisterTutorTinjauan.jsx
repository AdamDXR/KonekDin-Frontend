...
// ─── Data mock ───────────────────────────────────────────────────────────────
const DOCS = [
  { type: "file", name: "TRANSKRIP_NILAI_MAHASISWA.pdf", label: "Transkrip Nilai", uploaded: true },
  { type: "link", value: "https://github.com/omni-micro", label: "Portofolio", uploaded: true },
  { type: "image", name: "Sertifikat_Data_Science.jpg", label: "Sertifikat", uploaded: true },
];

const MATKUL = ["Algoritma dan Struktur Data", "Basis Data", "Pemrograman Berbasis Web", "Kecerdasan Buatan (Artificial Intelligence)"];
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-col gap-3">
                {DOCS.map((doc, idx) => (
                  <DocRow key={idx} doc={doc} onEdit={() => navigate("/register/tutor/dokumen")} />
                ))}
              </div>
            </div>
