  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="px-3 pb-5 space-y-0.5">
        ...
        <button className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-slate-500 hover:text-red-600 hover:bg-red-50 w-full transition-colors">
